 ...
 * @author Sindhu
 */
public class AssociateInterceptor implements HandlerInterceptor{
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) throws Exception {
        ...
        if (session.getAttribute("user") != null) {
                ...
                if (user.getRole().equalsIgnoreCase("associate")) {
                    try{
                        ...
                        System.out.println("Inside associate interceptor");
                        return true;
                }
        }
